<table border = 0 height = 30 width = 629 align = "center" bgcolor = "#f5ff34"> 
	<tr>
	...
	<tr>
		...
		<td rowspan = 3  width = 407 align = "center"> 
			...
			<input type = "text" name = "text" placeholder = "Ваша запись (Картинки меньше 2 мб)" style = "width:400px; height:42px"> </input>
		</td>
